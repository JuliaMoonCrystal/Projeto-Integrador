package br.org.generation.acacia.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.org.generation.acacia.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("Acacia")
			.description("Projeto API Spring - Acacia")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/vitorcool45/Projeto-Integrador")
			.contact(contact())
			.build();
	}
